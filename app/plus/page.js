...
export default function PlusPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <ScreenHeader title="Plus Entry" />

      <main className="flex-1 p-4 flex flex-col gap-5 max-w-lg mx-auto w-full">
        <div className="bg-brand-green-lt border border-brand-border rounded-2xl px-4 py-3 text-sm text-brand-green font-medium">
          Record boxes <strong>received from</strong> a party
        </div>
